...
# Script para reescrever a autoria dos commits em todos os repositórios
...
# Exemplo: TOKEN=seu_token_aqui ./rewrite_author.sh

REPOS_DIR="/home/ubuntu/github_repos"
LOG_FILE="/home/ubuntu/rewrite_author_log.txt"
